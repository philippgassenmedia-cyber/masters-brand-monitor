  ...
  return (
    <AppShell user={auth.user}>
      <div className="pb-16">
        ...
        {cfg.banner && (
          <div className={`mt-3 flex items-center gap-3 rounded-2xl border px-5 py-3 text-sm font-medium ${cfg.banner}`}>
        ...
        {/* Two-column grid on XL: main content left, action panel right */}
        <div className="mt-5 grid gap-5 xl:grid-cols-[1fr_360px] xl:items-start">
